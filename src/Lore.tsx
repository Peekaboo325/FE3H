...
const TOPICS = [
  { title: '제국', sub: '남녘을 다스리는 검은 독수리의 제위', img: '/assets/illust/lore-empire.webp' },
  { title: '왕국', sub: '북녘 기사들의 신앙과 충의', img: '/assets/illust/lore-kingdom.webp' },
  { title: '동맹', sub: '동녘 제후들의 원탁과 책략', img: '/assets/illust/lore-alliance.webp' },
  { title: '교단', sub: '여신의 가르침과 세이로스의 위계', img: '/assets/illust/lore-church.webp' },
  { title: '만상', sub: '어느 깃발에도 매이지 않는 만물의 기록', img: '/assets/illust/lore-myriad.webp' },
];
