...
// 수신 지정 후보 — A의 인연(설계서 §13). 잠든·사망도 다 보인다(빌더 결정).
//  id=등록 인물(명부 카드 있음) / id null=인연 칸만 있는 미등록 상대(고인 등) → 이름으로 지목.
export type LetterRecipient = { id: number | null; name: string; gone: boolean; sleeping: boolean };
