...
//  · 사건·인과 + 인물이 용인·제지·허용·거부·침묵한 관계·태도의 결정적 순간 + 명시적 상태 변화.
//    해석·심리 추측·미사여구·날짜는 버린다(순간은 '사실'로만 기록 — 그 무게의 평가는 안 함).
...
- 본문에서 실제로 일어난 사건의 인과와 인물의 행동·결정·결과를 2~5문장으로.
- ⚠️ 줄거리 사건만 적지 말 것. 인물이 무엇을 '용인·제지·허용·거부·묵인'했는지, 무엇을 말하거나 일부러 말하지 않았는지 — 호칭·태도·관계의 결을 가르는 결정적 순간도 똑같이 '사건'으로 기록한다. 그 화의 핵심이 거기 있을 때가 많다.
- 단 일어난 그대로만 적고 해석·평가·추측은 붙이지 않는다(심리 추측 "슬퍼 보인다"·"누그러진다"·"~을 시사한다" 류 금지). 행동·발화·선택 자체가 곧 기록이다.
