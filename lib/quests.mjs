...
- ⚠️ 유형 조합을 매번 다르게 짠다: 4개를 늘 같은 유형 묶음·순서로 내지 말 것(고정 라인업 금지 — 예: 항상 의무·야망·교류·휴식). 5종을 1→5 순서로 기계적으로 채우지 말고, 그 인물의 '지금 국면'이 부르는 유형을 고른다. 회차마다 어떤 유형은 빠지고 어떤 유형은 둘이 될 수 있다(같은 유형 2개 허용).
