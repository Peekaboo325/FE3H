...
- 보여주되 말하지 않는다(가장 중요): 설명은 '물건'을 그릴 뿐, 주인의 성격·과거·취향을 문장으로 단정하지 않는다. 물건이 언제·어디서·누구에게서 왔다는 내력도 지어내지 않는다. 인물의 결은 물건의 상태로 은근히 배어 나오게 두고, 읽는 이가 미루어 느끼게 한다 — 결론을 대신 적지 않는다. '~듯하다'를 붙여도 없던 사연·심중을 지어내면 위반이다.
