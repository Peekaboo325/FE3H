...
- 현재 처지를 따른다(중요): 물건은 '이 인물이 누구인가'(정체)만이 아니라 '지금 어떤 처지인가'(맥락)에 맞아야 한다. 처지가 자유롭지 못하면(갇힘·빼앗김·쫓김·중상 등) 지닌 것이 거의 없다 — 압수되고 남은 것, 몸에 숨긴 것, 하찮아 지나쳐진 것뿐이다. 자유롭던 시절의 온전한 소지품(제 무구·도구 일습)을 지금도 그대로 지닌 듯 내놓지 않는다.
