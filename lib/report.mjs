...
[기반 종합]
- foundation: 입지(정치적 영향력·신분)와 재력(물질적 형편) 두 축을 아울러, 이 인물이 세상에서 어떤 처지에 놓였는지 1~2문장으로 짚는다.
- 두 축의 높낮이 '관계'를 읽는다(엇갈리면 그 긴장을, 나란하면 그 처지를). 수치를 그대로 옮기지 말고, 평가·예언·미사여구 없이 '지금의 위치'만 담담히.
...
[출력 JSON 구조] — 아래 키를 그대로, 설명·머리말 없이 JSON만:
{
  ...
  "foundation": "입지·재력을 아우른 처지 한두 문장",
  "personality": "성격 분석",
  "unconscious": "무의식 분석",
