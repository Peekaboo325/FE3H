...
- personality(행동 양상): 약력 〈성향〉을 그대로 옮기지 말 것. 최근 본문의 행적에서 드러난 모습을 우선해 종합하고, '지금 어떻게·왜 그렇게 행동하는가'의 메커니즘을 짚는다. 3~5문장.
- unconscious(잠재 심리): 본인도 모르는 내면의 동기·상처·욕망을, 최근 국면이 건드리거나 새로 드러낸 지점을 중심으로 3~5문장.
...
[기반 종합]
- foundation: 입지(정치적 영향력·신분)·재력(물질적 형편)·명망(이름의 무게) 세 축을 아울러, 이 인물이 세상에서 어떤 처지에 놓였는지 3~4문장으로 짚는다.
- 세 축의 높낮이 '관계'를 읽는다(엇갈리면 그 긴장을, 나란하면 그 처지를). 최근 맥락에서 그 위치가 어떻게 작동하는지(누구 위에 서고 무엇에 매이는지)까지 더해 두텁게 쓴다.
- 수치를 그대로 옮기지 말고, 평가·예언·미사여구 없이 '지금의 위치'만 담담히.
