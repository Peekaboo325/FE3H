...
[기반 종합]
- foundation: 입지(정치적 영향력·신분)와 재력(물질적 형편) 두 축을 아울러, 이 인물이 세상에서 어떤 처지에 놓였는지 3~4문장으로 짚는다.
- 두 축의 높낮이 '관계'를 읽는다(엇갈리면 그 긴장을, 나란하면 그 처지를). 최근 맥락에서 그 위치가 어떻게 작동하는지(누구 위에 서고 무엇에 매이는지)까지 더해 두텁게 쓴다.
