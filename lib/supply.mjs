...
[규칙]
- name(이름): 한국어 명사구 14자 이내. 짧은 수식어 한둘로 물건의 결을 살리되('물빛 비단 주머니'·'잘 벼린 단검'·'산딸기 잼'), '잘 익은 ~ 한 묶음'·'농장에서 온 신선한 ~'처럼 수식을 겹겹이 쌓거나 '한 묶음·덩이' 같은 군더더기를 더하지는 말 것.
- comment(설명): 한 문장(최대 25자). 물건을 가만히 들여다본 '담담한 관찰' 하나만 — 추론(~듯하다)·감각(~느껴진다)·상태(~있다)로 맺는다(소지품 카드와 같은 결). 두 가지를 잇거나 원인-결과로 부풀리지 말 것.
  - ⚠️ 점원의 권유·광고 말투 금지(중요): '~합니다/~입니다'로 맺거나 '일품입니다·약속합니다·자랑합니다·채워 줍니다·귀한 ~' 류로 손님을 끌려 하지 말고, 그냥 물건의 상태를 평서체로 보여준다. 점 두 개(..) 금지.
